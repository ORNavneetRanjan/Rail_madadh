        ...
        <div className="w-1/3 flex flex-col h-full">
          <span className="flex justify-between">
            ...
            <Card
              ...
              word={"https://www.indianrail.gov.in/enquiry/StaticPages/StaticEnquiry.jsp?StaticPage=index.html"}
            />
            <Card
              link={
          ...
          <span className="flex justify-between">
            ...
            <Card
              ...
              label={"UTS Ticketing"}
              word={"https://play.google.com/store/apps/details?id=com.cris.utsmobile&hl=en_IN&pli=1"}
            />
            <Card
              link={
                "https://railmadad.indianrailways.gov.in/madad/final/images/booking-icon-5.png"
